...
export const baseDropOffSchema = z.object({
    ...
    specialFare: z.coerce.number({message: 'Please enter a valid number'}).min(1, 'Required'),
    multipleFare: z.coerce.number({message: 'Please enter a valid number'}).min(1, 'Required'),
